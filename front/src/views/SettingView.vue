            ...
            <n-form label-placement="top">
              ...
              <n-form-item label="body">
                <n-input
                  ...
                  @change="handleSettingChange('notification', 'body', settings.notification.body)"
                />
              </n-form-item>
              <n-form-item label="username">
                <n-input
                  ...
                  @change="
                    handleSettingChange('notification', 'username', settings.notification.username)
                  "
                />
              </n-form-item>
              <n-form-item label="password">
                <n-input
                  ...
                  show-password-on="click"
                  @change="
                    handleSettingChange('notification', 'password', settings.notification.password)
                  "
                />
              </n-form-item>
...
import { checkUpdateApi, testNotificationApi, type UpdateInfo } from "../services/api"
