  ...
  <div style="padding: 0 2.5% 0 2.5%">
    <n-card hoverable>
      ...
      >
        ...
        <div class="form-btn">
          <n-button strong secondary type="info" size="large" @click="Validate"> 保存 </n-button>
        </div>
      </n-form>
    </n-card>
    <n-card style="margin-top: 1rem" hoverable>
      <n-form-item label-placement="left" label-width="auto" label="设备" path="device">
        <n-select
      ...
      <n-button strong secondary type="info" block @click="connectDevices"> 连接 </n-button>
    </n-card>
  </div>
</template>
<script setup>
